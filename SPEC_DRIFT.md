...
- [§4.2] — `src/app/(app)/listings/new/page.tsx`, `src/app/(app)/requests/RequestsClient.tsx`, `src/app/(app)/transport/available/CapacityClient.tsx`, `src/app/(auth)/onboarding/OnboardingClient.tsx`, auth pages — Components create a Supabase browser client directly (auth checks / inserts) instead of going through the repository layer. — debt
