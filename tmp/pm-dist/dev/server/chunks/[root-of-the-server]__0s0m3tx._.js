...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://aevzcvlzfvrdipgofczx.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_YGv1yRkzeOmHT2iFsPtshw_gidtjhYs"), {
        cookies: {
            getAll () {
    ...
    const isPublicRoute = path === "/" || isOnboardingRoute || PUBLIC_PREFIXES.some((prefix)=>path.startsWith(prefix));
    ...
    if (user && isAppRoute) {
        const { data: profile } = await supabase.from("profiles").select("account_types").eq("id", user.id).maybeSingle();
        const hasCompletedOnboarding = (profile?.account_types?.length ?? 0) > 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0s0m3tx._.js.map