          ...
          <section className="rounded-2xl border border-pm-border bg-white p-6 shadow-sm sm:p-8">
                ...
                <dd
                  className={
                    state.agreement.priceAgreed
                      ? "text-sm font-bold text-pm-charcoal"
                      : "text-sm font-bold text-pm-gold-600"
                  }
                >
                  {state.agreement.rate ?? "To be agreed"}
                </dd>
              </div>
              <div>
                <dt className="text-xs text-pm-muted">Transport</dt>
                <dd
                  className={
                ...
                >
                  {state.agreement.transportArranged
                    ? `${state.agreement.transportCompany} — ${state.agreement.transportPrice}`
                    : "Pending"}
                </dd>
              </div>
            </dl>
            ...
            {isComplete && (
              <p className="mt-5 flex items-center gap-2 rounded-lg bg-pm-success/10 px-4 py-3 text-sm font-semibold text-pm-success">
                ...
                Everything&apos;s agreed and transport is booked.
              </p>
            )}
