    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl bg-white p-9 text-center shadow-2xl">
        ...
        <p className="mt-1 text-sm text-pm-muted">
          Next, briefly switch to John&apos;s view to accept the discussion, then
          return to James&apos;s shared workspace.
        </p>
        ...
        <Link
          href="/"
          className="mt-4 block text-sm font-medium text-pm-muted hover:text-pm-charcoal"
        >
          Back to home
        </Link>
      </div>
